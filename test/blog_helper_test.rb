...
class BlogHelperTest < Test::Unit::TestCase
  ...
  def test_create_tag_link_list
    ...
    result_04 = BlogHelper::create_tag_link_list(STRING_04)
    p result_04
